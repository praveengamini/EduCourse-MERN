...
export default function NewCourse() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-black text-gray-100 p-4 overflow-hidden">
            <div className="absolute top-25 left-4 z-20">
                <button 
                onClick={() => navigate(-1)} 
                className="bg-violet-700 hover:bg-violet-800 text-white px-4 py-2 rounded-lg shadow-md transition-all duration-200 cursor-pointer"
                >
                ← Back
                </button>
            </div>
