...
import EditCourseModal from '@/components/admin-view/EditCourse';
...
const CourseDetail = () => {
  ...
  const confirmDeleteCourse = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      await axios.delete(`${import.meta.env.VITE_SERVER_URL}/api/admin/courses/${courseId}`, {
        headers: {
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl">
            ...
            <p className="text-gray-600 text-center mb-6">
              Are you sure you want to delete "<span className="font-semibold text-gray-900">{course.title}</span>"? 
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                disabled={isDeleting}
                className="flex-1 px-4 py-2 text-white bg-red-600 hover:bg-red-700 rounded-lg font-medium transition-colors duration-200 disabled:opacity-50 flex items-center justify-center"
              >
                {isDeleting ? (
                  <>
